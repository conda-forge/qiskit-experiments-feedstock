...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/qiskit-experiments-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/qiskit-experiments-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add qiskit-experiments
# for installing globally
pixi global install qiskit-experiments
```
...
It is possible to list all of the versions of `qiskit-experiments` available on your platform:
...
```
pixi search qiskit-experiments --channel conda-forge
```
